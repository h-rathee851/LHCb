...
void redBsJ(){
  ...
  TFile* file  = new TFile("out2G.root");
  ...
  Double_t g2_MM; tree->SetBranchAddress("g2_MM", &g2_MM);
  ...
  Double_t eminus2_ProbNNe; tree->SetBranchAddress("eminus2_ProbNNe", &eminus2_ProbNNe);
  Double_t eplus2_ProbNNe; tree->SetBranchAddress("eplus2_ProbNNe", &eplus2_ProbNNe);
  


  TFile *newfile = new TFile("fin2G.root","recreate");
  ...
  for (auto i =0 ; i < tree->GetEntries(); ++i){
	   ...
	   if ( eminus1_ProbNNe > 0.2 && eplus1_ProbNNe > 0.2 &&  eminus2_ProbNNe > 0.2 && eplus2_ProbNNe > 0.2 && pi0_PT > 500  && pi0_MM > 120  && Bs_LOKI_MASS_JpsiConstr > 5300 && Bs10_LOKI_DTF_CHI2NDOF_BsJpsiPi0Constr < 5 && pi0_MM < 150 && Bs_LOKI_MASS_JpsiConstr < 5400 && g1_MM < ((Bs10_OWNPV_Z*.04)+20) && g2_MM < ((Bs10_OWNPV_Z*.04)+20)){
