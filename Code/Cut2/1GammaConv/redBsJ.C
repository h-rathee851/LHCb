...
void redBsJ(){
  ...
  TFile* file  = new TFile("out1G.root");
  ...
  TFile *newfile = new TFile("fin1G.root","recreate");
  ...
  for (auto i =0 ; i < tree->GetEntries(); ++i){
	   ...
	   if (eminus1_ProbNNe > 0.2 && eplus1_ProbNNe > 0.2 && g2_IsNotH > 0.1 && pi0_PT > 300  && pi0_MM > 120  && Bs_LOKI_MASS_JpsiConstr > 5300 && Bs10_LOKI_DTF_CHI2NDOF_BsJpsiPi0Constr < 5 && pi0_MM < 150 && Bs_LOKI_MASS_JpsiConstr < 5400 && g1_MM < ((Bs10_OWNPV_Z*.04)+20) ){
