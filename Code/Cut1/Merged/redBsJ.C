...
void redBsJ(){
 ...
 // Double_t g1_MM; tree->SetBranchAddress("g1_M", &g1_MM);
  ...
  TFile *newfile = new TFile("smallBsJ2.root","recreate");
  ...
  for (auto i =0 ; i < tree->GetEntries(); ++i){
	   ...
	   if (pi0_PT > 500  && pi0_M > 120 && Bs10_LOKI_DTF_CHI2NDOF_BsDsPi0Constr < 5 && pi0_M < 150 && Bs_LOKI_MASS_DsConstr > 5300 && Bs_LOKI_MASS_DsConstr < 5400){
