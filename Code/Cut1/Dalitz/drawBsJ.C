...
void drawBsJ(){
  ...
  TH1F* hist1 = new TH1F("hist1", "hist1", 100,5400,5400);
  ...
  for (auto i =0 ; i < tree->GetEntries(); ++i){
	   ...
	   if( eminus1_ProbNNe > 0.2 && eplus1_ProbNNe > 0.2 && g2_IsNotH > 0.1 && pi0_PT > 500  && pi0_MM > 110  && Bs_LOKI_MASS_DsConstr > 5300 && Bs10_LOKI_DTF_CHI2NDOF_BsDsPi0Constr < 5 && pi0_MM < 180 && Bs_LOKI_MASS_DsConstr < 5400 )
	     {
