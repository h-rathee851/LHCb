...
void drawBsJ(){
  ...
  TFile *file =  new TFile("smallBsM.root");
 ...
 // Double_t g1_MM; tree->SetBranchAddress("g1_M", &g1_MM);
  ...
  TH1F* hist1 = new TH1F("hist1", "hist1", 100,5400,5900);
  ...
  for (auto i =0 ; i < tree->GetEntries(); ++i){
	   ...
	   // pi0_Vetogg == 0 && ;
	   //  &&  g1_MM < ((Bs10_OWNPV_Z*.04)+20) && g2_MM < ((Bs10_OWNPV_Z*.04)+20)
	   // pi0_MM 120-150?
	   
	   if(  g1_IsNotH > 0.1 && g2_IsNotH > 0.1 && pi0_PT > 500  && pi0_MM > 110 && g1_PT > 300 && g2_PT > 300 && Bs10_LOKI_DTF_CHI2NDOF_BsDsPi0Constr < 5 && pi0_MM < 180 && Bs_LOKI_MASS_DsConstr > 5300 && Bs_LOKI_MASS_DsConstr < 5400)
	     {


	       if(Bs10_LOKI_MASS_BsDsPi0Constr > 0){
