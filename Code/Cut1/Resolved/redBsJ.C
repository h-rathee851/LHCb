...
void redBsJ(){
 ...
 // Double_t g1_MM; tree->SetBranchAddress("g1_M", &g1_MM);
  ...
  for (auto i =0 ; i < tree->GetEntries(); ++i){
	   ...
	   if (g1_IsNotH > 0.1 && g2_IsNotH > 0.1 && pi0_PT > 500  && pi0_MM > 120 && g1_PT > 300 && g2_PT > 300 && Bs10_LOKI_DTF_CHI2NDOF_BsDsPi0Constr < 5 && pi0_MM < 150 && Bs_LOKI_MASS_DsConstr > 5325 && Bs_LOKI_MASS_DsConstr < 5415){
