...
void drawBsJ(){
  ...
  for (auto i =0 ; i < tree->GetEntries(); ++i){
	   ...
	   if( eminus1_ProbNNe > 0.2 && eplus1_ProbNNe > 0.2 &&  eminus2_ProbNNe > 0.2 && eplus2_ProbNNe > 0.2 && pi0_PT > 500  && pi0_MM > 110  && Bs_LOKI_MASS_DsConstr > 5300 && Bs10_LOKI_DTF_CHI2NDOF_BsDsPi0Constr < 5 && pi0_MM < 180 && Bs_LOKI_MASS_DsConstr < 5400 && g1_MM < ((Bs10_OWNPV_Z*.04)+20) && g2_MM < ((Bs10_OWNPV_Z*.04)+20) )
	     {
